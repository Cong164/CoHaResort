...
<head>
	...
	<title>Đăng Nhập | COHA RESORT</title>
...
position: absolute;" background="resort details photos/bg2.jpg">
	...
	<div class="form-box">
		...
		<div class="social-icons">
			<img src="resort details photos/fb.png">
			<img src="resort details photos/tw.png">
			<img src="resort details photos/gp.png">
		</div>
		<form id="login" class="input-group" method="post" action="login.php">
			<input type="text" class="input-field" placeholder="Email" name="logininput" value="<?php if (isset($_COOKIE['logininput'])) {
				echo $_COOKIE['logininput'];
			} ?>" required>
			<input type="password" class="input-field" placeholder="Mật Khẩu" name="password" value="<?php if (isset($_COOKIE['password'])) {
			...
			<input type="checkbox" class="chech-box" name="rememberme" selected><span>Nhớ Mật Khẩu</span>
		...
		<form id="register" class="input-group" method="post" action="login.php">
			<input type="text" class="input-field" placeholder="Tên" name="name" required>
			<input type="email" class="input-field" placeholder="Email" name="email" required>
			<input type="number" class="input-field" placeholder="Số Điện Thoại" maxlength="10" name="mobno"
				required>
			<input type="password" class="input-field" placeholder="Mật Khẩu " name="password" l required>

			<input type="checkbox" class="chech-box" required><span>Tôi đồng ý với<a href="TC.html"> điều khoản và điều kiện</a></span>
