...
<head>
	<title>Hoá Đơn<?php echo $book_place ?></title>
...
<body
	style="background-image:linear-gradient(rgba(0 , 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('resort details photos/singup bg.jpeg')">
			...
			<div class="panel panel-warning">
				<div class="panel-header">
					...
					<font face="cambria" size="30px">
						<p align="center" style="margin-top:10px;">Hoá Đơn</p>
					</font>
				</div>
				<hr>
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td><u>Sau</u> <b>09:00:00 PM</b></td>
									</tr>
									<tr>
										<td><b>Checkout</b></td>
										<td><?php echo $_GET['checkout']; ?></td>
										<td><u>Trước</u> <b>09:00:00 AM</b></td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<form action="vnpay_pay.php">
						<div class="container">
							<div class="form-group">
								<input type="checkbox" required> <b>Thanh toán trực tuyến</b>
							</div>
							<div class="form-group">
								<input type="checkbox" required><a href="TC.html" target='blank'> <b>Điều kiện và điều khoản </b></a>
							</div>
							<input type="submit" class="btn btn-warning" value="Tiếp tục thanh toán">
						</div>
					</form>
