...
<html>
    <head>
        <title>Tìm Kiếm | COHA RESORT</title>
...
if($s_checkin>$s_checkout)
	...
	?>
		 <div class="hero-wrap" style="background-image:linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('resort details photos/bgbg.jpg');height:100%;
        width: 100%;
	  ...
	  <div class="backimage">
		...
		<div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
               ...
               <font face="Rockwell" size="42px"><p class="mb-3 bread tc" style="color:#f1f1f1; margin-top:55%; "><b>Kết Quả </b> <?php echo $s_cat.' At '.$s_checkin.' - '.$s_checkout; ?></p></font>
		   ...
		   echo'<div class="col-md-1"></div>
				...
				<img class="class-img-top thumbnail" src="'.$rows['img'].'" style="margin-top: 20px; height:30vh;width:26rem" >
					<div class="card-body">
					  ...
					  <a href="Resort Detail/'.$rows['name'].'.html" target="blank" class="btn pull-right" style="background-color: DodgerBlue; color:white;">Details</a>
