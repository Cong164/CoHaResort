...
<body>
  ...
  <div class="hero-wrap" style="background-image:linear-gradient(rgba(0 , 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('resort details photos/card back.jpg');height:100%;
        width: 100%;
          ...
          echo '<div class="col-md-1"></div>
            ...
            <img class="class-img-top thumbnail" src="' . $row['img'] . '" style="margin-top: 20px; height:30vh;width:26rem" >
                <div class="card-body">
                  ...
                  <a href="Resort Detail/' . $row['name'] . '.html" target="blank" class="btn pull-right" style="background-color: DodgerBlue; color:white;">Chi Tiết</a>
