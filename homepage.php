          ...
          <div class="media block-6 services">
            <div class="media-body py-md-4">
              <div class="d-flex mb-3 align-items-center">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="resort details photos\icon1.png" style="height: 100px; width: 100px;">
          ...
          <div class="media block-6 services">
            <div class="media-body py-md-4">
              <div class="d-flex mb-3 align-items-center">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="resort details photos\icon3.png" style="height: 100px; width: 100px;">
          ...
          <div class="media block-6 services">
            <div class="media-body py-md-4">
              <div class="d-flex mb-3 align-items-center">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="resort details photos\icon2.png" style="height: 100px; width: 100px;">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="media block-6 services services-2">
              <div class="media-body py-md-4 text-center">
                ...
                <img src="resort details photos\icon location.png" style="height: 100px; width: 100px;">
          ...
          <div class="col-md-4  ftco-animate">
            <div class="media block-6 services services-2">
              <div class="media-body py-md-4 text-center">
                ...
                <img src="resort details photos\icontime.png" style="height: 100px; width: 100px;">
          ...
          <div class="col-md-4  ftco-animate">
            <div class="media block-6 services services-2">
              <div class="media-body py-md-4 text-center">
                ...
                <img src="resort details photos\iconfarm.png" style="height: 100px; width: 100px;">
          ...
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled"><br>
                <li><a href="about.php" class="py-2 d-block" style="color:white;">Giới Thiệu</a></li>
